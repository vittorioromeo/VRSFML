...
#include "SFML/Base/Fmt/FmtNumeric.hpp" // IWYU pragma: export -- fmtToString() callers virtually always want numeric support
#include "SFML/Base/NonDeduced.hpp"
#include "SFML/Base/String.hpp"


////////////////////////////////////////////////////////////
/// \brief Opt-in extension: `fmtToString(fmt, args...) -> base::String`.
///
