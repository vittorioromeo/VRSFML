...
{
////////////////////////////////////////////////////////////
/// \brief Default scratch buffer size for numeric parsers. Comfortably
...
/// fast path. `ScnStringSource` and `InFile` are examples.
////////////////////////////////////////////////////////////
template <typename T>
...
////////////////////////////////////////////////////////////
template <ScnSource S>
[[nodiscard]] constexpr bool scnAtEnd(S& src)
{
