...
/// ellipseData.horizontalRadius = 50.f;
/// ellipseData.verticalRadius = 30.f;
/// ellipseData.pointCount = 40; // More points for a smoother ellipse
/// ellipseData.fillColor = sf::Color::Cyan;
/// ellipseData.outlineColor = sf::Color::Blue;
/// ellipseData.outlineThickness = 2.f;
///
/// // ... (pass ellipseData to a shape rendering system or batch)
/// \endcode
///
