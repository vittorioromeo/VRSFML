...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API constexpr Rect();
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API constexpr Rect(const Vector2<T>& position, const Vector2<T>& size);
    ...
    ////////////////////////////////////////////////////////////
    template <typename U>
    SFML_SYSTEM_API constexpr explicit Rect(const Rect<U>& rectangle);
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API constexpr bool contains(const Vector2<T>& point) const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API constexpr std::optional<Rect<T>> findIntersection(const Rect<T>& rectangle) const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API constexpr Vector2<T> getPosition() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    SFML_SYSTEM_API constexpr Vector2<T> getSize() const;
