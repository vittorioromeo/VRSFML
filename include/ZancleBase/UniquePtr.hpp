...
///
////////////////////////////////////////////////////////////
struct ZB_TRIVIAL_ABI UniquePtrDefaultDeleter
{
    template <typename T>
...
///
/// `UniquePtr` is annotated with `ZB_TRIVIAL_ABI` so it is
...
class ZB_TRIVIAL_ABI UniquePtr : private TDeleter
{
