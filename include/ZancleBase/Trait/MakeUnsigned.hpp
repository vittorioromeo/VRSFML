...
// https://github.com/vittorioromeo/Zancle/blob/master/license.md
    ...
    ////////////////////////////////////////////////////////////
    #define ZB_MAKE_UNSIGNED(...) __make_unsigned(__VA_ARGS__)
...
// clang-format on
    ...
    ////////////////////////////////////////////////////////////
    #define ZB_MAKE_UNSIGNED(...) typename ::zb::priv::MakeUnsignedImpl<__VA_ARGS__>::type
...
////////////////////////////////////////////////////////////
template <typename T>
using MakeUnsigned = ZB_MAKE_UNSIGNED(T);
