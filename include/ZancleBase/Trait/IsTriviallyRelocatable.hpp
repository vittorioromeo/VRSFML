...
namespace zb::priv
{
    ...
    ////////////////////////////////////////////////////////////
    #define ZB_IS_TRIVIALLY_RELOCATABLE_BY_BUILTIN(...) __builtin_is_cpp_trivially_relocatable(__VA_ARGS__)

#elif __has_builtin(__is_trivially_relocatable)

    ////////////////////////////////////////////////////////////
    #define ZB_IS_TRIVIALLY_RELOCATABLE_BY_BUILTIN(...) __is_trivially_relocatable(__VA_ARGS__)

#else

    ////////////////////////////////////////////////////////////
    #define ZB_IS_TRIVIALLY_RELOCATABLE_BY_BUILTIN(...) false
...
////////////////////////////////////////////////////////////
template <typename T>
inline constexpr bool isTriviallyRelocatable = ZB_IS_TRIVIALLY_RELOCATABLE(T);
