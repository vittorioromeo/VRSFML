...
////////////////////////////////////////////////////////////
    ...
    #define ZB_LAUNDER __builtin_launder

#else

    #include <new>

    #define ZB_LAUNDER ::std::launder
...
///
/// Convenience macro: `ZB_LAUNDER_CAST(T*, buffer)` is the
/// laundered equivalent of `reinterpret_cast<T*>(buffer)`.
///
////////////////////////////////////////////////////////////
#define ZB_LAUNDER_CAST(type, buffer) ZB_LAUNDER(reinterpret_cast<type>(buffer))
