...
#include "ZancleBase/Scn/ScnChar.hpp"    // IWYU pragma: export -- char overload (noD ADL on `char`)
#include "ZancleBase/Scn/ScnCore.hpp"    // IWYU pragma: export
#include "ZancleBase/Scn/ScnNumeric.hpp" // IWYU pragma: export -- int / float / bool overloads (no ADL on built-ins)
...
/// included: the target type (`zb::String`) brings `za::base` in
