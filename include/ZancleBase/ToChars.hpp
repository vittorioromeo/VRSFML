...
#include "ZancleBase/Builtin/Clzll.hpp"
#include "ZancleBase/Builtin/IsInf.hpp"
#include "ZancleBase/Builtin/IsNan.hpp"
#include "ZancleBase/Builtin/Signbit.hpp"
#include "ZancleBase/Math/Rint.hpp"
...
{
    static_assert(ZB_IS_UNSIGNED(T));
    ...
    const int t = decimalDigitsFromTopBit[63 - ZB_CLZLL(n | 1ull)];
...
{
    ZB_ASSERT(precision >= 0 && precision <= 10);
