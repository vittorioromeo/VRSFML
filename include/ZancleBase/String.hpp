...
#include "ZancleBase/Fmt/FmtAppendMixinFwd.hpp"
...
public:
    ...
    [[gnu::always_inline]] void resizeAndOverwrite(const SizeT newSize, Operation&& op)
    {
        ...
        ZB_ASSERT(actualSize <= newSize && "resizeAndOverwrite: returned size exceeds requested size");
...
#define ZB_PRIV_DEFINE_STRING_VIEW_BRIDGE(methodName)                    \
    ...
    [[nodiscard, gnu::always_inline, gnu::flatten, gnu::pure]] ZB_PRIV_DEFINE_STRING_VIEW_BRIDGE(substrByPosLen);
    [[nodiscard, gnu::always_inline, gnu::flatten, gnu::pure]] ZB_PRIV_DEFINE_STRING_VIEW_BRIDGE(find);
    [[nodiscard, gnu::always_inline, gnu::flatten, gnu::pure]] ZB_PRIV_DEFINE_STRING_VIEW_BRIDGE(rfind);
    [[nodiscard, gnu::always_inline, gnu::flatten, gnu::pure]] ZB_PRIV_DEFINE_STRING_VIEW_BRIDGE(findFirstOf);
    [[nodiscard, gnu::always_inline, gnu::flatten, gnu::pure]] ZB_PRIV_DEFINE_STRING_VIEW_BRIDGE(findLastOf);
    [[nodiscard, gnu::always_inline, gnu::flatten, gnu::pure]] ZB_PRIV_DEFINE_STRING_VIEW_BRIDGE(findFirstNotOf);
    [[nodiscard, gnu::always_inline, gnu::flatten, gnu::pure]] ZB_PRIV_DEFINE_STRING_VIEW_BRIDGE(findLastNotOf);
    [[nodiscard, gnu::always_inline, gnu::flatten, gnu::pure]] ZB_PRIV_DEFINE_STRING_VIEW_BRIDGE(startsWith);
    [[nodiscard, gnu::always_inline, gnu::flatten, gnu::pure]] ZB_PRIV_DEFINE_STRING_VIEW_BRIDGE(endsWith);
    [[nodiscard, gnu::always_inline, gnu::flatten, gnu::pure]] ZB_PRIV_DEFINE_STRING_VIEW_BRIDGE(contains);
    [[gnu::always_inline, gnu::flatten]] ZB_PRIV_DEFINE_STRING_VIEW_BRIDGE(forSplits);
    [[gnu::always_inline, gnu::flatten]] ZB_PRIV_DEFINE_STRING_VIEW_BRIDGE(forLines);

#undef ZB_PRIV_DEFINE_STRING_VIEW_BRIDGE
};
...
[[nodiscard, gnu::flatten, gnu::always_inline]] inline constexpr bool operator==(const String& lhs, const StringView rhs) noexcept
{
    ...
    return ZB_MEMCMP(lhs.data(), rhs.data(), lhs.size()) == 0;
}
