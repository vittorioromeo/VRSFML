...
/// `Fxx` alias is only defined when the matching `ZB_FLOATxx_DETECTED`
/// macro is available.
///
////////////////////////////////////////////////////////////
...
// Clang detection
        ...
        #define ZB_FLOAT16_DETECTED
    #endif

    #if !__is_identifier(_Float32)
        #define ZB_FLOAT32_DETECTED
    #endif

    #if !__is_identifier(_Float64)
        #define ZB_FLOAT64_DETECTED
    #endif

    #if !__is_identifier(_Float128)
        #define ZB_FLOAT128_DETECTED
    #endif
#endif
