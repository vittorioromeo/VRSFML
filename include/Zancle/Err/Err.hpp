...
////////////////////////////////////////////////////////////
using ErrSinkFn = void (*)(void* ctx, const char* data, za::SizeT size);
...
////////////////////////////////////////////////////////////
ZA_SYSTEM_API void emitErr(const char* data, za::SizeT size, bool trailing);
...
///
/// `za::String` is intentionally not exposed in this header. The
...
public:
    ...
    ////////////////////////////////////////////////////////////
    void append(const char* data, za::SizeT size);

    ////////////////////////////////////////////////////////////
    /// \brief Append formatted content to the buffered message.
    ///
    /// Routes through `za::fmtTo`, which uses `*this` as an `AppendSink`
    ...
    void fmt(typename za::NonDeduced<const za::FmtString<Args...>>::type fmtStr, const Args&... args)
    {
        (void)za::fmtTo(*this, fmtStr, args...);
    }
...
private:
    // Buffer-sized for the layout of `za::String` (3 pointers/sizes on
    // x86_64 = 24 bytes; rounded up for headroom and 32-bit safety).
    za::InPlacePImpl<za::String, 32> m_buf;
...
////////////////////////////////////////////////////////////
template <typename... Args>
void errMsg(typename za::NonDeduced<const za::FmtString<Args...>>::type fmtStr, const Args&... args)
{
    ErrMsgScope scope;
...
////////////////////////////////////////////////////////////
template <typename... Args>
void errMsgMulti(typename za::NonDeduced<const za::FmtString<Args...>>::type fmtStr, const Args&... args)
{
    ErrMsgScope scope;
