...
///
/// `za::Transformable` is a flat, non-polymorphic struct that
/// holds the position, scale, origin, and rotation members
/// (defined by `ZA_DEFINE_TRANSFORMABLE_DATA_MEMBERS`) plus
...
///
////////////////////////////////////////////////////////////
struct ZA_GRAPHICS_API Transformable : TransformableMixin
{
...
////////////////////////////////////////////////////////////
/// \class za::Transformable
/// \ingroup graphics
///
/// This class is provided for convenience, on top of `za::Transform`.
///
/// `za::Transform`, as a low-level class, offers a great level of
...
///
/// That's exactly what `za::Transformable` was written for: it hides
...
/// transform (as a `za::Transform`), and keeps it up-to-date.
///
/// In addition to the position, rotation and scale, `za::Transformable`
...
/// bottom-right corner.
///
/// To keep the `za::Transformable` class simple, there's only one
...
/// entity.rotation = za::degrees(45.f);
/// window.draw(entity);
/// \endcode
///
...
///     }
///
///     void draw(za::RenderTarget& target) const
///     {
///         target.draw(/* vertex data */, {.transform = myTransform.getTransform()});
///     }
///
/// private:
///     za::Transformable myTransform;
/// };
/// \endcode
///
...
///
/// \see `za::Transform`, `za::TransformableMixin`
///
////////////////////////////////////////////////////////////
