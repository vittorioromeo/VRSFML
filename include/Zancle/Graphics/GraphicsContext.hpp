...
/// resource (`za::RenderWindow`, `za::RenderTexture`,
/// `za::Texture`, ...) is created. The recommended pattern is
...
///
////////////////////////////////////////////////////////////
class [[nodiscard]] ZA_GRAPHICS_API GraphicsContext
{
public:
    ////////////////////////////////////////////////////////////
    ...
    ///
    /// \return `GraphicsContext` on success, `za::nullOpt` on failure
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] static za::Optional<GraphicsContext> create();
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] explicit GraphicsContext(za::PassKey<GraphicsContext>&&, WindowContext&& windowContext);
...
/// int main()
/// {
///     auto gfx = za::GraphicsContext::create().value();
///
...
///
/// \see `za::AudioContext`, `za::WindowContext`,
///      `za::RenderWindow`, `za::RenderTexture`,
///      `za::DefaultShader`
///
////////////////////////////////////////////////////////////
