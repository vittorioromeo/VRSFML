...
///
////////////////////////////////////////////////////////////
class ZA_GRAPHICS_API RectangleShape : public Shape
{
public:
    ////////////////////////////////////////////////////////////
    /// \brief Initialization data for `za::RectangleShape`
    ///
    /// Alias for `za::RectangleShapeData`.
    ///
    ////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////
/// \class za::RectangleShape
/// \ingroup graphics
///
/// `za::RectangleShape` is the concrete `za::Shape` subclass for
/// drawing an axis-aligned rectangle. In addition to the
/// transform and appearance members inherited from `za::Shape`,
...
/// \endcode
///
/// \see `za::Shape`, `za::CircleShape`, `za::ConvexShape`,
