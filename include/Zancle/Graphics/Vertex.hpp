...
/// const za::Vertex vertices[]
/// {
///     {{  0.f,   0.f}, za::Color::Red, { 0.f,  0.f}},
///     {{  0.f, 100.f}, za::Color::Red, { 0.f, 10.f}},
///     {{100.f, 100.f}, za::Color::Red, {10.f, 10.f}},
///     {{  0.f,   0.f}, za::Color::Red, { 0.f,  0.f}},
///     {{100.f, 100.f}, za::Color::Red, {10.f, 10.f}},
///     {{100.f,   0.f}, za::Color::Red, {10.f,  0.f}}
/// };
///
/// // Draw the vertex array as triangles.
/// window.draw(vertices, za::PrimitiveType::Triangles);
/// \endcode
///
...
/// za::Vertex v1{{5.f, 5.f}, za::Color::Red};             // explicit 'position' and 'color', defaulted 'texCoords'
/// za::Vertex v2{{5.f, 5.f}, za::Color::Red, {1.f, 1.f}}; // everything is explicitly specified
///
/// za::Vertex v3{
///    .position{5.f, 5.f},
///    .texCoords{1.f, 1.f}
...
///
/// \see `za::VertexBuffer`, `za::DrawableBatch`
///
////////////////////////////////////////////////////////////

// TODO P1: investigate what it would take to make `za::Vertex` customizable!
