...
///
/// `za::EllipseShapeData` is used to specify the characteristics
...
///
////////////////////////////////////////////////////////////
struct [[nodiscard]] ZA_GRAPHICS_API EllipseShapeData : LocalAnchorPointMixin, GlobalAnchorPointMixin
{
...
////////////////////////////////////////////////////////////
/// \struct za::EllipseShapeData
/// \ingroup graphics
///
/// `za::EllipseShapeData` is a plain struct that holds the geometric
...
///
/// This struct is typically used together with `za::ShapeUtils` to
/// produce vertex data, with `za::Shape` for a drawable wrapper, or
...
/// Example usage:
/// \code
/// const za::EllipseShapeData ellipseData{
///     .fillColor        = za::Color::Cyan,
///     .outlineColor     = za::Color::Blue,
...
/// \endcode
///
/// \see `za::Shape`, `za::ShapeUtils`, `za::CircleShapeData`, `za::RectangleShapeData`
///
////////////////////////////////////////////////////////////
