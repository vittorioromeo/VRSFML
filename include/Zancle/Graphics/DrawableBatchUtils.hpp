...
////////////////////////////////////////////////////////////
/// \namespace za::DrawableBatchUtils
/// \ingroup graphics
///
/// `za::DrawableBatchUtils` is a collection of low-level
/// `inline constexpr` helpers used by the drawable batching
/// implementation to append index and vertex data into raw
/// arrays. They are intended for use by `za::CPUDrawableBatch`,
/// `za::PersistentGPUDrawableBatch`, and other custom batchers
