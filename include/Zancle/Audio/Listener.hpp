...
/// and how sounds are heard for a given `za::PlaybackDevice`.
...
/// `za::PlaybackDevice::applyListener`.
///
/// \see `za::PlaybackDevice`, `za::Sound`, `za::Music`
///
////////////////////////////////////////////////////////////
struct ZA_AUDIO_API Listener
{
    ////////////////////////////////////////////////////////////
...
/// where and how sounds/musics are heard. If a `za::View` is
/// the eyes of the user, then `za::Listener` is their ears
/// (the two are often linked together with the same position
/// and orientation).
///
/// `za::Listener` is a simple aggregate that you mutate
/// directly and then apply to a playback device via
/// `za::PlaybackDevice::applyListener`. Each playback device
