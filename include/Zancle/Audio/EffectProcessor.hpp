...
/// retrieved using `za::PlaybackDevice::getSampleRate()`.
///
...
///
////////////////////////////////////////////////////////////
class [[nodiscard]] ZA_AUDIO_API EffectProcessor : public priv::EffectProcessorImpl
{
public:
