...
/// with `za::SoundStream<State>` (the public user-facing
/// template) or inherit `MiniaudioSoundSource` yourself and
/// compose a `SoundStreamState` (what `za::Music` does, to
/// keep `SoundStream.hpp` out of its public header).
///
/// \see `za::SoundStream`, `za::Music`
///
////////////////////////////////////////////////////////////
...
public:
    ...
    /// `MiniaudioSoundSource` (e.g. `za::Music`) and need to
...
////////////////////////////////////////////////////////////
/// \class za::SoundStreamState
/// \ingroup audio
///
/// `za::SoundStreamState<State>` is the low-level primitive
/// for producing audio on demand: unlike `za::SoundBuffer`,
...
/// used by `za::SoundStream<State>` (the public user-facing
/// template that adds the `play`/`pause`/`setVolume` API) and
/// by `za::Music` (which composes it via pImpl). Most users
/// will want `za::SoundStream<State>` directly.
///
/// \see `za::SoundStream`, `za::Music`, `za::Sound`
///
////////////////////////////////////////////////////////////
