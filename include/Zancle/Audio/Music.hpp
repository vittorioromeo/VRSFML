...
/// `za::Sound`: it pulls samples on demand from a
/// `za::MusicReader` instead of holding the entire decoded
...
///
/// A `Music` instance is bound to a `za::PlaybackDevice` and a
/// `za::MusicReader`; both must outlive the music object.
///
/// `Music` also adds support for custom loop sub-ranges via
/// `setLoopPoints` / `getLoopPoints`.
///
////////////////////////////////////////////////////////////
class ZA_AUDIO_API Music : public priv::MiniaudioSoundSource
{
public:
    ////////////////////////////////////////////////////////////
...
/// `za::Music` object.
///
/// Apart from that, a `za::Music` has almost the same features as
/// the `za::SoundBuffer` / `za::Sound` pair: you can play/pause/stop
...
/// \endcode
///
/// \see `za::Sound`, `za::SoundStream`, `za::AudioSettings`
///
////////////////////////////////////////////////////////////
