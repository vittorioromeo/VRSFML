...
///
////////////////////////////////////////////////////////////
class ZA_AUDIO_API InputSoundFile
{
public:
    ////////////////////////////////////////////////////////////
...
private:
    ...
    ///
    ////////////////////////////////////////////////////////////
    struct ZA_AUDIO_API StreamDeleter
    {
...
////////////////////////////////////////////////////////////
/// \class za::InputSoundFile
/// \ingroup audio
///
/// This class decodes audio samples from a sound file. It is
/// used internally by higher-level classes such as `za::SoundBuffer`
/// and `za::Music`, but can also be useful if you want to process
/// or analyze audio files without playing them, or if you want to
/// implement your own version of `za::Music` with more specific
/// features.
///
/// Usage example:
/// \code
/// // Open a sound file
/// auto file = za::InputSoundFile::openFromFile("music.ogg").value();
///
...
/// \endcode
///
/// \see `za::SoundFileReader`, `za::OutputSoundFile`
///
////////////////////////////////////////////////////////////
