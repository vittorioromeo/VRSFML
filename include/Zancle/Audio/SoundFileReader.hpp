...
///
////////////////////////////////////////////////////////////
class ZA_AUDIO_API SoundFileReader
{
public:
    ////////////////////////////////////////////////////////////
...
///
/// To register a new reader, use the `za::SoundFileFactory::registerReader`
/// template function.
///
/// Usage example:
/// \code
/// class MySoundFileReader : public za::SoundFileReader
/// {
/// public:
///
///     [[nodiscard]] static bool check(za::InputStream& stream)
///     {
...
/// \endcode
///
/// \see `za::InputSoundFile`, `za::SoundFileFactory`, `za::SoundFileWriter`
///
////////////////////////////////////////////////////////////
