...
public:
    ...
    public:
        ...
        enum class Status
        {
            ...
            InvalidResponse = 1000, //!< Not part of the FTP standard, generated by Zancle when a received response cannot be parsed
            ConnectionFailed = 1001, //!< Not part of the FTP standard, generated by Zancle when the low-level socket connection with the server fails
            ConnectionClosed = 1002, //!< Not part of the FTP standard, generated by Zancle when the low-level socket connection is unexpectedly closed
            InvalidFile = 1003 //!< Not part of the FTP standard, generated by Zancle when a local file cannot be read or written
        };
        ...
        ///
        ////////////////////////////////////////////////////////////
        [[nodiscard]] explicit Response(Status code = Status::InvalidResponse, za::StringView message = "");
        ...
        ///
        ////////////////////////////////////////////////////////////
        [[nodiscard]] za::StringView getMessage() const;
    ...
    private:
        ...
        ////////////////////////////////////////////////////////////
        struct Impl;
        za::InPlacePImpl<Impl, 64> m_impl; //!< Implementation details
    };
    ...
    ///
    ////////////////////////////////////////////////////////////
    class ZA_NETWORK_API DirectoryResponse : public Response
    {
    public:
        ////////////////////////////////////////////////////////////
        DirectoryResponse();
    ...
    ///        file name listing
    ////////////////////////////////////////////////////////////
    class ZA_NETWORK_API ListingResponse : public Response
    {
    public:
        ////////////////////////////////////////////////////////////
        /// \brief Default constructor
        ...
        ///
        ////////////////////////////////////////////////////////////
        [[nodiscard]] ListingResponse(const Response& response, za::StringView data);
        ...
        ///
        ////////////////////////////////////////////////////////////
        [[nodiscard]] za::Span<const za::String> getListing() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] Response login(za::StringView name, za::StringView password);
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] ListingResponse getDirectoryListing(za::StringView directory = "");
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] Response changeDirectory(za::StringView directory);
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] Response createDirectory(za::StringView name);
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] Response deleteDirectory(za::StringView name);
    ...
    /// functions in the `za::Ftp` class, this method can be used
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] Response sendCommand(za::StringView command, za::StringView parameter = "");
...
/// \ingroup network
///
/// `za::Ftp` is a very simple FTP client that allows you
...
/// `za::Ftp::Response` to provide this data. The most often used
...
/// they are generated by Zancle when an internal error occurs.
///
...
/// za::Ftp::Response response = ftp.connect("ftp://ftp.myserver.com");
/// if (response.isOk())
///     std::cout << "Connected" << '\n';
///
/// // Log in
...
/// za::Ftp::DirectoryResponse directory = ftp.getWorkingDirectory();
/// if (directory.isOk())
...
/// response = ftp.upload("local-path/file.txt", "files", za::Ftp::TransferMode::Ascii);
/// if (response.isOk())
