...
///
////////////////////////////////////////////////////////////
class ZA_NETWORK_API UdpSocket : public Socket
{
public:
    ////////////////////////////////////////////////////////////
    // Constants
    ...
    ///
    /// When providing `za::Socket::AnyPort` as port, the listener
...
/// interface uses packets (see `za::Packet`), which are easier
/// to use and provide more safety regarding the data that is
/// exchanged. You can look at the `za::Packet` class to get
...
/// std::string message = "Hi, I am " + za::IpAddress::getLocalAddress().toString();
...
/// \endcode
///
/// \see `za::Socket`, `za::TcpSocket`, `za::Packet`
///
////////////////////////////////////////////////////////////
