...
/// \ingroup network
///
/// `za::Http` is a very simple HTTP client that allows you
...
/// \li `za::Http`
///
/// `za::Http::Request` builds the request that will be
...
///
/// `za::Http::Response` parse the response from the web server
/// and provides getters to read them. The response contains:
/// \li a status code
/// \li header fields (that may be answers to the ones that you requested)
/// \li a body, which contains the contents of the requested resource
///
/// `za::Http` provides a simple function, SendRequest, to send a
/// `za::Http::Request` and return the corresponding `za::Http::Response`
/// from the server.
///
/// Usage example:
/// \code
...
///
/// // Send the request
/// za::Http::Response response = http.sendRequest(request);
///
/// // Check the status code and display the result
/// za::Http::Response::Status status = response.getStatus();
/// if (status == za::Http::Response::Status::Ok)
/// {
