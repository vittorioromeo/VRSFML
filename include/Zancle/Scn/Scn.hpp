...
[[nodiscard]] constexpr bool scnInto(S& src, T& out)
{
    ...
    else
    {
        static_assert(false,
                      ...
                      "provides it (e.g. <Zancle/Scn/ScnNumeric.hpp> for int/float/bool, "
                      "<Zancle/Scn/ScnChar.hpp> for char, <Zancle/Scn/ScnString.hpp> for "
                      "za::String) -- or provide your own `scnArg(MySource&, MyType&)` in MyType's or "
...
/// included: the target type (`za::String`) brings `za::base` in
