...
/// `<Zancle/Scn/Scn.hpp>`, which also pulls in the primitive body
...
/// dedicated headers:
///   - `<Zancle/Scn/ScnChar.hpp>`       -- `char`
///   - `<Zancle/Scn/ScnString.hpp>`     -- `za::String` + `scnReadLine`
///   - `<Zancle/Scn/ScnNumeric.hpp>`    -- int / float / bool + `scnRadix`
///
