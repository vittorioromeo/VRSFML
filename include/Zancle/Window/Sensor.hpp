...
struct Sensor
{
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] ZA_WINDOW_API static bool isAvailable(Type sensor);
    ...
    ///
    ////////////////////////////////////////////////////////////
    ZA_WINDOW_API static void setEnabled(Type sensor, bool enabled);
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] ZA_WINDOW_API static Vec3f getValue(Type sensor);
};
...
/// `za::Sensor::isAvailable` function.
///
...
/// all disabled by default. You must call `za::Sensor::setEnabled` for each
/// sensor in which you are interested.
///
/// Usage example:
/// \code
/// if (za::Sensor::isAvailable(za::Sensor::Type::Gravity))
/// {
///     // gravity sensor is available
/// }
///
/// // enable the gravity sensor
/// za::Sensor::setEnabled(za::Sensor::Type::Gravity, true);
///
/// // get the current value of gravity
/// za::Vec3f gravity = za::Sensor::getValue(za::Sensor::Type::Gravity);
/// \endcode
///
////////////////////////////////////////////////////////////
