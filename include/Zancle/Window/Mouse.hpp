...
/// \ingroup window
///
/// `za::Mouse` provides an interface to the state of the
...
/// and `MouseButtonReleased` events, `za::Mouse` can retrieve the
...
/// Usage example:
/// \code
/// if (za::Mouse::isButtonPressed(za::Mouse::Button::Left))
/// {
///     // left click...
/// }
///
/// // get global mouse position
/// za::Vec2i position = za::Mouse::getPosition();
///
/// // set mouse position relative to a window
/// za::Mouse::setPosition(za::Vec2i{100, 200}, window);
/// \endcode
///
/// \see `za::Joystick`, `za::Keyboard`, `za::Touch`
///
////////////////////////////////////////////////////////////
