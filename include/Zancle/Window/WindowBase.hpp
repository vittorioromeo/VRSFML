...
///
////////////////////////////////////////////////////////////
class ZA_WINDOW_API WindowBase : public GlobalAnchorPointMixin, public LocalAnchorPointMixin
{
public:
    ////////////////////////////////////////////////////////////
    ...
    /// window/control. Unlike `za::Window::create`, this base
    ...
    ///
    /// \see `za::Vulkan::isAvailable`, `za::Vulkan::VulkanSurfaceData`
    ///
    ////////////////////////////////////////////////////////////
...
#include "Zancle/Window/WindowBase.inl"
...
/// own an OpenGL context: use `za::Window` (which derives
