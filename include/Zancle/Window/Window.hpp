...
///
////////////////////////////////////////////////////////////
class ZA_WINDOW_API Window : public WindowBase
{
public:
    ////////////////////////////////////////////////////////////
...
/// \ingroup window
///
/// `za::Window` is the main class of the Window module. It defines
/// an OS window that is able to receive an OpenGL rendering.
///
/// A `za::Window` can create its own new window, or be embedded into
...
///
/// The `za::Window` class provides a simple interface for manipulating
...
/// OpenGL context attached to the window, with the `za::ContextSettings`
