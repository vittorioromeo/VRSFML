...
struct ZA_WINDOW_API Keyboard
{
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] static bool isKeyPressed(Scancode code);
    ...
    ///         `za::Keyboard::Key::Unknown` when the scancode cannot be mapped
    ///         to a Key.
    ///
    /// \see `delocalize`
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] static Key localize(Scancode code);
    ...
    ///         keyboard layout used by the operating system, or
    ///         `za::Keyboard::Scan::Unknown` when the key cannot be mapped
    ///         to a `za::Keyboard::Scancode`.
    ///
    /// \see `localize`
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] static Scancode delocalize(Key key);
    ...
    ///
    /// \warning The result is OS-dependent: for example, `za::Keyboard::Scan::LSystem`
    ...
    /// interpret the scancode: for example, `za::Keyboard::Key::Semicolon` is
...
/// \ingroup window
///
/// `za::Keyboard` provides an interface to the state of the
/// keyboard.
///
/// This struct allows users to query the keyboard state at any
/// time and directly, without having to deal with a window and
/// its events. Compared to the `KeyPressed` and `KeyReleased` events,
/// `za::Keyboard` can retrieve the state of a key at any time
...
///     // move right...
/// }
/// else if (za::Keyboard::isKeyPressed(za::Keyboard::Key::Escape))
/// {
///     // quit...
/// }
/// else if (za::Keyboard::isKeyPressed(za::Keyboard::Scan::Grave))
/// {
///     // open in-game command line (if it's not already open)
/// }
/// \endcode
///
/// \see `za::Joystick`, `za::Mouse`, `za::Touch`
///
////////////////////////////////////////////////////////////
