...
#define ZA_PRIV_DEFINE_MIXIN_GETTER(name, ...)                                                                   \
    ...
    ///
    ////////////////////////////////////////////////////////////
    ZA_PRIV_DEFINE_MIXIN_GETTER(getGlobalTopLeft, {0.f, 0.f});

    ////////////////////////////////////////////////////////////
    /// \brief Get the world position of the top-center anchor point
    ///
    ////////////////////////////////////////////////////////////
    ZA_PRIV_DEFINE_MIXIN_GETTER(getGlobalTopCenter, {0.5f, 0.f});

    ////////////////////////////////////////////////////////////
    /// \brief Get the world position of the top-right anchor point
    ///
    ////////////////////////////////////////////////////////////
    ZA_PRIV_DEFINE_MIXIN_GETTER(getGlobalTopRight, {1.f, 0.f});

    ////////////////////////////////////////////////////////////
    /// \brief Get the world position of the center-left anchor point
    ///
    ////////////////////////////////////////////////////////////
    ZA_PRIV_DEFINE_MIXIN_GETTER(getGlobalCenterLeft, {0.f, 0.5f});

    ////////////////////////////////////////////////////////////
    /// \brief Get the world position of the center anchor point
    ///
    ////////////////////////////////////////////////////////////
    ZA_PRIV_DEFINE_MIXIN_GETTER(getGlobalCenter, {0.5f, 0.5f});

    ////////////////////////////////////////////////////////////
    /// \brief Get the world position of the center-right anchor point
    ///
    ////////////////////////////////////////////////////////////
    ZA_PRIV_DEFINE_MIXIN_GETTER(getGlobalCenterRight, {1.f, 0.5f});

    ////////////////////////////////////////////////////////////
    /// \brief Get the world position of the bottom-left anchor point
    ///
    ////////////////////////////////////////////////////////////
    ZA_PRIV_DEFINE_MIXIN_GETTER(getGlobalBottomLeft, {0.f, 1.f});

    ////////////////////////////////////////////////////////////
    /// \brief Get the world position of the bottom-center anchor point
    ///
    ////////////////////////////////////////////////////////////
    ZA_PRIV_DEFINE_MIXIN_GETTER(getGlobalBottomCenter, {0.5f, 1.f});

    ////////////////////////////////////////////////////////////
    /// \brief Get the world position of the bottom-right anchor point
    ///
    ////////////////////////////////////////////////////////////
    ZA_PRIV_DEFINE_MIXIN_GETTER(getGlobalBottomRight, {1.f, 1.f});
...
#define ZA_PRIV_DEFINE_MIXIN_SETTER(name, ...)                                                                \
    ...
    ///
    ////////////////////////////////////////////////////////////
    ZA_PRIV_DEFINE_MIXIN_SETTER(setGlobalTopLeft, {0.f, 0.f});

    ////////////////////////////////////////////////////////////
    /// \brief Set the world position of the top-center anchor
    ///
    ////////////////////////////////////////////////////////////
    ZA_PRIV_DEFINE_MIXIN_SETTER(setGlobalTopCenter, {0.5f, 0.f});

    ////////////////////////////////////////////////////////////
    /// \brief Set the world position of the top-right anchor
    ///
    ////////////////////////////////////////////////////////////
    ZA_PRIV_DEFINE_MIXIN_SETTER(setGlobalTopRight, {1.f, 0.f});

    ////////////////////////////////////////////////////////////
    /// \brief Set the world position of the center-left anchor
    ///
    ////////////////////////////////////////////////////////////
    ZA_PRIV_DEFINE_MIXIN_SETTER(setGlobalCenterLeft, {0.f, 0.5f});

    ////////////////////////////////////////////////////////////
    /// \brief Set the world position of the center anchor
    ///
    ////////////////////////////////////////////////////////////
    ZA_PRIV_DEFINE_MIXIN_SETTER(setGlobalCenter, {0.5f, 0.5f});

    ////////////////////////////////////////////////////////////
    /// \brief Set the world position of the center-right anchor
    ///
    ////////////////////////////////////////////////////////////
    ZA_PRIV_DEFINE_MIXIN_SETTER(setGlobalCenterRight, {1.f, 0.5f});

    ////////////////////////////////////////////////////////////
    /// \brief Set the world position of the bottom-left anchor
    ///
    ////////////////////////////////////////////////////////////
    ZA_PRIV_DEFINE_MIXIN_SETTER(setGlobalBottomLeft, {0.f, 1.f});

    ////////////////////////////////////////////////////////////
    /// \brief Set the world position of the bottom-center anchor
    ///
    ////////////////////////////////////////////////////////////
    ZA_PRIV_DEFINE_MIXIN_SETTER(setGlobalBottomCenter, {0.5f, 1.f});

    ////////////////////////////////////////////////////////////
    /// \brief Set the world position of the bottom-right anchor
    ///
    ////////////////////////////////////////////////////////////
    ZA_PRIV_DEFINE_MIXIN_SETTER(setGlobalBottomRight, {1.f, 1.f});
...
/// `struct MyObject : public za::Transformable, public za::GlobalAnchorPointMixin`
/// The inheriting class must provide `getGlobalBounds()` and have a public
/// `position` member of type `za::Vec2f` (or expose `getPosition`/`setPosition`).
///
