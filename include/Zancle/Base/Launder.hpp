...
///
/// Convenience macro: `ZA_LAUNDER_CAST(T*, buffer)` is the
/// laundered equivalent of `reinterpret_cast<T*>(buffer)`.
///
////////////////////////////////////////////////////////////
#define ZA_LAUNDER_CAST(type, buffer) ZA_LAUNDER(reinterpret_cast<type>(buffer))
