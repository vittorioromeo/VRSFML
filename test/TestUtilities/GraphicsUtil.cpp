...
{
////////////////////////////////////////////////////////////
sf::base::String StringMaker<sf::BlendMode>::convert(const sf::BlendMode& blendMode)
{
...
////////////////////////////////////////////////////////////
sf::base::String StringMaker<sf::StencilComparison>::convert(const sf::StencilComparison comparison)
{
    switch (comparison)
    {
...
////////////////////////////////////////////////////////////
sf::base::String StringMaker<sf::StencilUpdateOperation>::convert(const sf::StencilUpdateOperation updateOperation)
{
...
////////////////////////////////////////////////////////////
sf::base::String StringMaker<sf::StencilMode>::convert(const sf::StencilMode& stencilMode)
{
    return sf::base::String{"( "} + StringMaker<sf::StencilComparison>::convert(stencilMode.stencilComparison) +
           sf::base::String{", "} + StringMaker<sf::StencilUpdateOperation>::convert(stencilMode.stencilUpdateOperation) +
           sf::base::String{", "} + sf::base::String{stencilMode.stencilOnly ? "true" : "false"} +
           sf::base::String{", "} + gfxIntToString(static_cast<unsigned int>(stencilMode.stencilReference.value)) +
           sf::base::String{", "} + gfxIntToString(static_cast<unsigned int>(stencilMode.stencilMask.value)) +
           sf::base::String{" )"};
}


////////////////////////////////////////////////////////////
sf::base::String StringMaker<sf::Color>::convert(const sf::Color color)
{
...
////////////////////////////////////////////////////////////
sf::base::String StringMaker<sf::Transform>::convert(const sf::Transform& transform)
{
    // clang-format off
...
////////////////////////////////////////////////////////////
sf::base::String StringMaker<sf::View>::convert(const sf::View& view)
{
...
////////////////////////////////////////////////////////////
template <typename T>
sf::base::String StringMaker<sf::Rect2<T>>::convert(const sf::Rect2<T>& rect)
{
...
////////////////////////////////////////////////////////////
sf::base::String StringMaker<sf::View::ScissorRect>::convert(const sf::View::ScissorRect& scissorRect)
{
