...
file(READ "src/CMakeLists.txt" FLAC_SRC_CMAKELISTS_CONTENTS)
string(REGEX REPLACE "\nadd_subdirectory\\(\"share/" "\n\#add_subdirectory(\"share/" FLAC_SRC_CMAKELISTS_CONTENTS "${FLAC_SRC_CMAKELISTS_CONTENTS}")
file(WRITE "src/CMakeLists.txt" "${FLAC_SRC_CMAKELISTS_CONTENTS}")

file(READ "CMakeLists.txt" FLAC_CMAKELISTS_CONTENTS)
...
file(WRITE "CMakeLists.txt" "${FLAC_CMAKELISTS_CONTENTS}")
