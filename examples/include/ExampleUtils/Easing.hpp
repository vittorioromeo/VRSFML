...
////////////////////////////////////////////////////////////
[[nodiscard, gnu::always_inline, gnu::flatten, gnu::const]] inline constexpr float easeInOutBackWithCustomOvershoot(
    const float x,
...
////////////////////////////////////////////////////////////
[[nodiscard, gnu::always_inline, gnu::flatten, gnu::const]] inline constexpr float easeInBackWithCustomOvershoot(
    const float x,
    const float overshoot) noexcept
{
    SFML_BASE_ASSERT_AND_ASSUME(x >= 0.f && x <= 1.f);
...
////////////////////////////////////////////////////////////
[[nodiscard, gnu::always_inline, gnu::flatten, gnu::const]] inline constexpr float easeOutBackWithCustomOvershoot(
    const float x,
    const float overshoot) noexcept
{
    SFML_BASE_ASSERT_AND_ASSUME(x >= 0.f && x <= 1.f);
...
{
    return easeInOutBackWithCustomOvershoot(x, 1.70158f);
}
...
{
    return easeInBackWithCustomOvershoot(x, 1.70158f);
}
...
{
    return easeOutBackWithCustomOvershoot(x, 1.70158f);
}
