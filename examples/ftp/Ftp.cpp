...
////////////////////////////////////////////////////////////
/// `MiniFmt` ADL hook for FTP response types. Lives in `namespace sf`
/// so ADL finds it for the nested `sf::Ftp::Response*` types.
////////////////////////////////////////////////////////////
namespace sf
{
inline void formatArg(sf::base::FormatSink& sink, const Ftp::Response& response, const sf::base::FormatSpec&)
{
    sink.format("{}{}", static_cast<int>(response.getStatus()), response.getMessage());
}
} // namespace sf
