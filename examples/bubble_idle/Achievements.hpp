...
inline constexpr AchievementData achievementData[] = {
    ...
    {"Abraca-paw-dabra", "Complete the 1st shrine (\"Shrine of Magic\")."},
    {"Purrfectly Clicked", "Complete the 2nd shrine (\"Shrine of Clicking\")."},
    {"Auto-Mew-tation", "Complete the 3th shrine (\"Shrine of Automation\")."},
    {"Repulsolution", "Complete the 4th shrine (\"Shrine of Repulsion\")."},
    {"Attract-a-Paw", "Complete the 5th shrine (\"Shrine of Attraction\")."},
