...
struct [[nodiscard]] GameConstants
{
    ...
    za::Vec2f        brainJarOffset{210.f, -235.f};
    za::Vec2f        uniWingsOffset{250.f, -175.f};
    za::Vec2f        uniWingsOriginOffsetFromCenter{35.f, 10.f};
    za::Vec2f        devilBookOffset{10.f, 20.f};
    za::Vec2f        devilPawIdleOffset{4.f, 2.f};
    za::Vec2f        devilPawDraggedOffset{-6.f, 6.f};
    SpriteAttachment duckFlag{{335.f, -65.f}, {98.f, 330.f}};
    za::Vec2f        smartHatOffset{-150.f, -535.f};
    za::Vec2f        earFlapOffset{-131.f, -365.f};
    za::Vec2f        yawnOffset{-221.f, 25.f};
    ...
    za::Vec2f        uniTailExtraOffset{-130.f, 405.f};
    za::Vec2f        uniTailOriginOffset{250.f, 0.f};
    SpriteAttachment mouseProp{{-275.f, -15.f}, {53.f, 77.f}};
    za::Vec2f        eyelidOffset{-185.f, -185.f};
    za::Vec2f        regularPawIdleOffset{0.f, 0.f};
    za::Vec2f        regularPawDraggedOffset{-12.f, 12.f};
    za::Vec2f        copyMaskOffset{265.f, 115.f};
    za::Vec2f        copyMaskOrigin{353.f, 295.f};
    ...
    za::Vec2f wardenGuardhouseBackOffset{0.f, 0.f};
    za::Vec2f wardenGuardhouseFrontOffset{0.f, 0.f};
    za::Vec2f wardenCatBodyOffset{0.f, 0.f};
    za::Vec2f wardenCatPawOffset{0.f, 0.f};
    ...
    za::Vec2f wardenCatEyelidOriginOffset{0.f, 0.f};
    za::Vec2f wardenCatYawnOriginOffset{0.f, 0.f};
    ...
    za::Vec2f wardenCatBatonWindupOffset{100.f, -80.f};
