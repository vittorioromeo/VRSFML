...
////////////////////////////////////////////////////////////
int frameCallback(void* data, zb::UIntPtrT pc, const char* filename, int lineno, const char* function)
{
    ...
    ZB_SCOPE_GUARD({ std::free(demangled); }); // NOLINT(cppcoreguidelines-no-malloc, hicpp-no-malloc)
