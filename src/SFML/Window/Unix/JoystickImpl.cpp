...
void JoystickImpl::initialize()
{
    ...
    if (!udevContext)
    {
        err() << "Failed to create udev context, joystick support not available" << errEndl;
        return;
    }
    ...
    if (!udevMonitor)
    {
        err() << "Failed to create udev monitor, joystick connections and disconnections won't be notified" << errEndl;
    }
    else
    {
