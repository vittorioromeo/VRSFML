...
bool RenderTextureImplFBO::createFrameBuffer()
{
    ...
    {
        priv::err() << "Impossible to create render texture (failed to create the frame buffer object)" << std::endl;
        return false;
    }
...
bool RenderTextureImplFBO::activate(bool active)
{
    ...
    if (!contextId)
    {
        ...
        {
            priv::err() << "Failed to set context as active during render texture activation" << std::endl;
            return false;
        }
        ...
        if (!contextId)
        {
            priv::err() << "Impossible to activate render texture (failed to create backup context)" << std::endl;
            return false;
        }
    }
